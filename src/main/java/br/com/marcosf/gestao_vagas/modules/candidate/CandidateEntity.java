package br.com.marcosf.gestao_vagas.modules.candidate;
...
public class CandidateEntity {
    ...
    @Schema(example = "Marcos Freitas", requiredMode = RequiredMode.REQUIRED, description = "Nome do candidato")
    private String name;
    
    @NotBlank
    @Pattern(regexp = "\\S+", message = "Este campo não deve conter espaço")
    @Schema(example = "marcos", requiredMode = RequiredMode.REQUIRED, description = "Usuário do candidato")
    private String username;

    @Email(message = "O campo e-mail deve conter um e-mail válido")
    @Schema(example = "candidato@dominio.com.br", requiredMode = RequiredMode.REQUIRED, description = "E-mail do candidato")
